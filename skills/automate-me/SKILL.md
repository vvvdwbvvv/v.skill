...
The **vvvdwbvvv** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as vvvdwbvvv's.
...
- The **vvvdwbvvv** skill: example of the output shape.
